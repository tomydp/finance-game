                        ...
                        <form wire:submit.prevent="update">
                            <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select
                                        wire:model.live="editType"
                                        class="mt-1 w-full rounded border p-2 @error('editType') border-red-500 ring-1 ring-red-500 @enderror"
                                    >
                                        <option value="mcq">Opción múltiple</option>
                                        <option value="true_false">Verdadero / Falso</option>
                                        <option value="fill_blank">Completar</option>
                                    </select>
                                    @error('editType') <p class="mt-1 block text-left text-xs text-red-600">{{ $message }}</p> @enderror
                                </div>
