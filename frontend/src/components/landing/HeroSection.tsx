      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2">
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
            ¡La forma{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">divertida</span>,{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-500">efectiva</span> y{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-cyan-400">gratis</span> de aprender{' '}
            <span className="text-cyan-400">finanzas</span>!
          </h1>

          <p className="mt-6 text-gray-300 text-lg">
            Domina tus finanzas personales con lecciones interactivas, desafíos divertidos y un enfoque gamificado que hace el aprendizaje adictivo.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <button
              onClick={goToLogin}
              className="px-8 py-4 bg-cyan-400 text-white font-semibold rounded hover:bg-cyan-500 transition"
            >
              YA TENGO UNA CUENTA
            </button>
          </div>
